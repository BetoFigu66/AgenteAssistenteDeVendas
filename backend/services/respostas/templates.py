...
CONFIRMAR_EMPRESA = """Identifiquei que você está falando em nome da empresa *{empresa}* (CNPJ {cnpj}).
Está correto?"""
...
# Escalonamento
ESCALADO_HUMANO = """Claro! Vou passar sua solicitação para um de nossos atendentes.
Em breve alguém entrará em contato por aqui. 🙋"""

RECLAMACAO_ESCALADA = """Lamento pelo inconveniente! Vou escalar sua solicitação para nosso time de suporte.
Em breve alguém entrará em contato."""

# Fallback
NAO_ENTENDI = """Desculpa, não entendi muito bem. Pode reformular sua mensagem?
Se preferir, posso transferir para um atendente humano."""

FORA_CONTEXTO = """Sou o assistente de vendas da Inforrel e posso ajudar com catracas e relógios de ponto.
Em que posso te ajudar?"""

# Fallback quando RAG nao encontra trechos com score suficiente
PRODUTO_SEM_CONTEXTO = """Ainda não tenho uma resposta precisa sobre isso por aqui.
Posso te passar para um de nossos atendentes para te ajudar melhor? 🙋"""

# Orçamento (status)
ORCAMENTO_APROVADO = """Perfeito! Orçamento aprovado registrado.
Nosso time comercial dará continuidade ao processo e entrará em contato em breve. 🎉"""

ORCAMENTO_REPROVADO = """Tudo bem, agradeço o retorno.
