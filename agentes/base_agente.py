...
def nome_pasta(nome: str) -> str:
    """Converte nome de agente em slug ASCII usado como nome de pasta."""
    return (
...
class BaseAgente(ABC):
    ...
    def __init__(self, nome: str, papel: str, projeto_root: str = None):
        ...
        self.artefatos_dir = Path(self.projeto_root) / "artefatos" / nome_pasta(self.nome)
